...
export class TopicsComponent implements OnInit {
  ...
  getTopics(standardId,subjectId,_standard,_subject){
    ...
    if(this.route.snapshot.params.standardId && this.route.snapshot.params.subjectId){
      this.student.getTopicById(this.route.snapshot.params.standardId,this.route.snapshot.params.subjectId)
      .subscribe(
        data=>
        {
          console.log(data);
      ...
      this.student.getTopicById(sessionStorage.getItem('standardId'),sessionStorage.getItem('subjectId')).subscribe(
        res => {
